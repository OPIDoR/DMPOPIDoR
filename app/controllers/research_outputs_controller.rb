...
class ResearchOutputsController < ApplicationController
  ...
  # SEE app/controllers/dmpopidor/research_outputs_controller.rb
  # --------------------------------
  prepend Dmpopidor::ResearchOutputsController
  # --------------------------------
  ...
  before_action :fetch_plan, except: %i[show select_output_type select_license repository_search
