...
module Resolvers
  # JsonbResolver provides utility methods to build SQL conditions for filtering
  # JSONB fields in PostgreSQL based on GraphQL input filters.
  class JsonbResolver < GraphQL::Schema::Resolver
    ...
    def self.jsonb_path_where(path:, value:, field:, operator: 'eq')
      operator_map = {
        'eq' => '==',
        'neq' => '!=',
        'like' => 'like_regex',
