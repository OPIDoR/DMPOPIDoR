    ...
    translations: {
      fr: {
        consentModal: {
          title: "Cookies",
          description:
            "Nous utilisons des cookies pour améliorer votre expérience et analyser notre site. Vous pouvez accepter tous les cookies, les refuser, ou gérer vos préférences.",
        ...
        preferencesModal: {
          ...
          sections: [
            ...
            {
              title:
                'Cookies de fonctionnalités <span class="pm__badge">Toujours Activé</span>',
              description:
                "Ces cookies permettent d’améliorer la performance et les fonctionnalités du site.",
            ...
            },
            {
              ...
              description:
                "Ces cookies nous permettent de suivre et d'analyser l'audience du site de manière anonyme afin d'améliorer la performance et l'expérience utilisateur. Toutes les informations collectées par ces cookies sont agrégées et donc anonymisées. Si vous n'autorisez pas ces cookies, nous ne saurons pas quand vous avez visité notre site et ne pourrons pas surveiller sa performance.",
            ...
            },
            {
              ...
              description:
                "Vous pouvez choisir d'accepter uniquement les cookies nécessaires ou d'accepter tous les cookies, y compris ceux d'analyse. Vous pouvez également personnaliser vos préférences en matière de cookies à tout moment en accédant aux paramètres des cookies sur notre site.",
            },
          ],
        },
      },
      en: {
        ...
        consentModal: {
          title: "Cookies",
          description:
            "We use cookies to improve your experience and analyse our site. You can accept all cookies, reject them, or manage your preferences.",
        ...
        preferencesModal: {
          ...
          sections: [
            ...
            {
              title:
                'Cookies Strictement Nécessaires <span class="pm__badge">Always enabled</span>',
              description:
                "These cookies are essential to enable you to browse our site and use its features. They cannot be deactivated in our systems. They are generally set in response to actions on your part, such as defining your confidentiality preferences, logging in or filling in forms.",
              linkedCategory: "necessary",
              cookieTable: {
            ...
            {
              title:
                'Functionality cookies <span class="pm__badge">Always enabled</span>',
              description:
                "These cookies are used to improve the site's performance and functionality.",
              linkedCategory: "functionality",
              cookieTable: {
                caption: "Cookies list",
                headers: {
            ...
            },
            {
              ...
              description:
                "You can choose to accept only necessary cookies or to accept all cookies, including analysis cookies. You can also personalise your cookie preferences at any time by accessing the cookie settings on our website..",
            },
          ],
        },
      },
