...
import { news } from "../../services/index.js";
      ...
      {data
        .map((r) => ({
          ...
          date: format(new Date(r.date), "dd/MM/yyyy", {
            locale: locales[i18n.resolvedLanguage || locale],
          }),
          full: r?._embedded?.["wp:featuredmedia"]?.[0]?.media_details?.sizes
            ?.full,
        }))
        .map((n, idx) => (
          <Col key={idx}>
              ...
              <Card.Body>
                ...
                <Card.Text
                  ...
                  dangerouslySetInnerHTML={{
                    __html: `${n.content.substring(0, 120)}...`,
                  }}
                  key={`content-${n.id}`}
                />
              </Card.Body>
