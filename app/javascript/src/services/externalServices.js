...
const getRor = async (query, filter) =>
  axios.get("/api/v1/madmp/services/ror", { params: { query, filter } });

const getOrcid = async (search) =>
  axios.get("/api/v1/madmp/services/orcid", { params: { search } });
