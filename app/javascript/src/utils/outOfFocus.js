document.addEventListener("turbo:load", () => {
  ...
  const focusables = $(
    "td, .dropdown, .dropdown-toggle, a[href], area[href], input:not([disabled]), select:not([disabled]), textarea:not([disabled]), button:not([disabled]), iframe, object, embed, [tabindex], [contenteditable]",
  );
