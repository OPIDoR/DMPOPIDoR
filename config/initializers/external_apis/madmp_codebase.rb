...
Rails.configuration.x.madmp_codebase.run_path = ENV.fetch('MADMP_CODEBASE_RUN_PATH', 'scripts/%s/run')
Rails.configuration.x.madmp_codebase.active = ENV.fetch('MADMP_CODEBASE_ACTIVE', true) == 'true'
