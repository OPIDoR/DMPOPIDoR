...
module DMPRoadmap
  ...
  class Application < Rails::Application
    ...
    config.x.organisation.name = ENV.fetch('ORGANISATION_NAME', 'Inist-CNRS Institut de l\'Information Scientifique et Technique')
    ...
    config.x.organisation.safe_email = ENV.fetch('ORGANISATION_SAFE_EMAIL', 'dmp.opidor<span style="display: none;">REMOVE</span>@inist.fr')
