...
RSpec.describe OrgAdmin::GuidancesController, type: :controller do
  before(:each) do
  ...
  it 'GET /org_admin/guidances' do
    get :index, params: { id: @org.id }
    expect(response).to render_template('org_admin/guidances/index')
  ...
  it 'GET /org_admin/guidances/new (:new)' do
    get :new, params: { id: @org.id }
    expect(response).to render_template('org_admin/guidances/new_edit')
    g = assigns(:guidance)
    expect(g.new_record?).to eql(true)
  end

  it 'GET /org_admin/guidances/:id/edit (:edit)' do
    get :edit, params: { id: @guidance.id }
    expect(response).to render_template('org_admin/guidances/new_edit')
    expect(assigns(:guidance)).to eql(@guidance)
  end

  describe 'POST /org_admin/guidances (:create)' do
    it 'succeeds' do
      args = { text: Faker::Lorem.paragraph, published: Faker::Boolean.boolean,
               guidance_group_id: @guidance_group.id, theme_ids: [@theme.id] }
      post :create, params: { id: @org.id, guidance: args }
      expect(response).to render_template('org_admin/guidances/new_edit')
  ...
  describe 'PUT /org_admin/guidances/:id (:update)' do
    it 'succeeds' do
      theme = create(:theme)
      gg = create(:guidance_group, org_id: @org.id)
      args = { text: Faker::Lorem.paragraph, published: Faker::Boolean.boolean,
               guidance_group_id: gg.id, theme_ids: [theme.id] }
      put :update, params: { id: @guidance.id, guidance: args }
      expect(response).to render_template('org_admin/guidances/new_edit')
      expect(flash[:notice].present?).to eql(true)
      g = assigns(:guidance)
  ...
  describe 'PUT /org_admin/guidances/:id/publish (:publish)' do
    before(:each) do
    ...
    it 'succeeds' do
      args = { published: true }
      put :publish, params: { id: @guidance.id, guidance: args }
    ...
    it 'fails' do
      ...
      put :apublish, params: { id: @guidance.id, guidance: args }
      expect(response).to redirect_to(org_admin_guidances_path)
      expect(flash[:alert].present?).to eql(true)
  ...
  describe 'PUT /org_admin/guidances/:id/unpublish (:unpublish)' do
    before(:each) do
    ...
    it 'succeeds' do
      args = { published: false }
      put :unpublish, params: { id: @guidance.id, guidance: args }
      expect(response).to redirect_to(org_admin_guidances_path)
      expect(flash[:notice].present?).to eql(true)
      expect(@guidance.reload.published?).to eql(false)
    end
    ...
    it 'unpublishes the GuidanceGroup if there is no other published guidance' do
      ...
      delete :destroy, params: { id: @guidance.id }
  ...
  describe 'DELETE /org_admin/guidances/:id (:destroy)' do
    it 'succeeds' do
      delete :destroy, params: { id: @guidance.id }
      expect(response).to redirect_to(org_admin_guidances_path)
      expect(flash[:notice].present?).to eql(true)
